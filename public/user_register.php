	                            ...
	                            <div class="form-bottom">
				                    <form id="form" role="form" action="user_register_process.php" method="post" class="login-form" data-toggle="validator">
				                    	<div class="form-group">
				                        	<input type="text" name="firstname" id="firstname" placeholder="First Name" class="form-username form-control" data-error="First Name is required!" required>
				                        	<div class="help-block with-errors"></div>
				                        </div>
				                        <div class="form-group">
				                        	<input type="text" name="lastname" id="lastname" placeholder="Last Name" class="form-username form-control" data-error="Last Name is required!" required>
				                        	<div class="help-block with-errors"></div>
				                        </div>
				                    	<div class="form-group">
