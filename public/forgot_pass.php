...
<html lang="en">
	<head>
		...
		<title>We'R'HR - Forgot Password</title>
		<!-- Bootstrap core CSS -->
							...
							<div class="form-box">
	                        	<div class="form-top">
	                        		<div class="form-top-left">
	                            		...
	                            		<p>Please enter your email. We will send you a recovery link</p>
	                        		</div>
	                            ...
	                            <div class="form-bottom">
				                    <form id="form" role="form" action="forgot_pass_process.php" method="post" class="login-form" data-toggle="validator">
