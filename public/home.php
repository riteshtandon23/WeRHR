...
<?php
    ...
    if(isset($_SESSION["fname"])==FALSE && isset($_SESSION["lname"])==FALSE){
        ...
        $sess_id = $_SESSION['id'];
        $result = $connection->query("SELECT act_status FROM users WHERE id='$sess_id' UNION ALL SELECT act_status FROM employers WHERE id='$sess_id'");
...
<head>
    ...
    <title><?php echo $_SESSION['fname']." ".$_SESSION['lname']."'s Dashboard"; ?></title>
