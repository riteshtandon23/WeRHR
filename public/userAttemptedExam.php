...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Exams <small>Last 5 Exams</small></h2>
                        ...
                        <div>
                            <ul class="list-unstyled top_profiles scroll-view">
                               <?php
                                ...
                                // echo "<p><strong>Exam Date: </strong> ".$row2['Exam_Date']."</p>";                                     
                                // echo "<p><strong>Exam Time: </strong> ".$row2['Start_Time']." - ".$row2['End_Time']."</p>";
                                // echo "<p> <small>Total Question: ".$row2['Total_Question']."</small>";
                                // echo "</p>";
                                // echo "</div>";
                                // echo "</li>";  
                                ?>
