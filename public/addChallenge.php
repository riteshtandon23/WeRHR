        ...
        <div class="x_content">
            ...
            <div class="item form-group">
			  ...
			  <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="email" id="email" name="email" required="required" min="1" data-validate-minmax="1,100" placeholder="Enter the Email" class="form-control col-md-7 col-xs-12">
                </div>
            </div>
