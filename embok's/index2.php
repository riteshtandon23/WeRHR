...
<head>
    ...
    <?php
        include 'headersNmenus/top_links_scripts.php';
    ?>
...
<?php
    include 'headersNmenus/mainpage_header.php';
?>
...
<!--div class="container_full slidertop">
    ...
    <div class="master-slider ms-skin-default" id="masterslider"-->
        ...
        <!--div class="ms-slide slide-1" data-delay="8"-->
            ...
            <!-- slide background -->
            <!--img src="js/masterslider/blank.gif" data-src="images/sliders/1920x720.jpg" alt=""/>     
    		...
    		>
    			Hello! This is Hoxa. Find the Benefits of Using<br />
    			<strong>Recommended to Highly.</strong>
    		</h1>
        ...
        <!--div class="ms-slide slide-2" data-delay="8"-->
    		...
    		>
    			...
    			<strong>Websites for your <em>Business</em></strong>
    		</h1>
        ...
        <!--div class="ms-slide slide-3" data-delay="8"-->
    		...
    		<img src="js/masterslider/blank.gif" data-src="images/sliders/630x576.jpg" alt=""
            ...
            <h3 class="ms-layer stext9"
                ...
                data-effect="scale(1.5,1.6)"
    		>
    			<i class="fa fa-paper-plane"></i> <br /> One Solution for <br /> <strong>All you Needs</strong>
    		</h3>
    		...
    		>
    			...
    			<strong>Find the <em>Benefits</em> of Using</strong>
    		</h1>
            
            <h4 class="ms-layer stext7"
    			style="left: 130px; top: 470px;"
    			data-type="text"
    			data-duration="900"
    			data-delay="2500"
    		...
    		<div class="ms-layer"
    			...
    			data-effect="scale(1.5,1.6)"
    		>
    			<a href="#" class="sbutton4">Get Started Now!</a>
    		</div>
