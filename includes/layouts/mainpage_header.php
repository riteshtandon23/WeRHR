      ...
      <div class="logoarea">
        ...
        <div class="container">
            ...
            <div class="container">
              ...
              </div> <!-- End of navbar-collapse-1 -->
            </div>     <!-- End of ..menu_main/container/navbar yamm navbar-default/container -->
          </div>       <!-- End of ..menu_main/container/navbar yamm navbar-default -->
        </div>         <!-- End of ..menu main/container -->
      </div><!-- end of Menu -->
    </div><!-- End of header/trueheader/wrapper --> 
	</div><!-- End of header/trueheader -->    
