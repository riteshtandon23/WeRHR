                ...
                <table id="example" class="table table-striped responsive-utilities jambo_table">
                    ...
                    <?php
                    	...
                    	while($row=$result->fetch_assoc())
						{
                            ...
                            $id=$row["Question_Id"];
                            echo "<td class=\" last\"><div class=\"buttons\"><a href=\"editOption1.php?id=$id\"><button type=\"button\" name=\"editquestion\" id=\"editquestion\" class=\"btn btn-info btn-xs\">Choose Option</button></a>
