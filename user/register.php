...
if(isset($_POST['submit'])){
	...
	$query1 = mysqli_query($connection,"select * from user1 where email='$email'");
...
print '</script>'; 
	...
	$query1 = mysqli_query($connection,"INSERT INTO user1(firstname,lastname, email,password) VALUES('$firstname','$lastname','$email','$password')");
		print '<script type="text/javascript">'; 
...
<div id="main">
	...
	<div class="content_fullwidth">
        ...
        <div class="reg_form">
        <form id="sky-form" class="sky-form" method="post" action="register.php">
